...
namespace CLIMFinders.Infrastructure.Migrations
{
    ...
    [Migration("20250303174211_alter vehicle table")]
    partial class altervehicletable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CLIMFinders.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedById = 1,
                            AddedOn = new DateTime(2025, 3, 3, 23, 12, 11, 303, DateTimeKind.Local).AddTicks(9332),
                            ConfirmationCode = "",
                            ConfirmedOn = new DateTime(2025, 3, 3, 23, 12, 11, 303, DateTimeKind.Local).AddTicks(9349),
                            Email = "admin@admin.com",
                            FullName = "Super Admin",
                            IsConfirmed = true,
                            IsDeleted = false,
                            ModifiedById = 1,
                            ModifiedOn = new DateTime(2025, 3, 3, 23, 12, 11, 303, DateTimeKind.Local).AddTicks(9347),
                            PasswordHash = "KjJCkgaNbvbHiyjLlwE8pp/er9/sMS9wY1S3xkKd6yM=",
                            PasswordSalt = "3UreGTnq66ZLLOnphSWcEA==",
                            RoleId = 3,
                            SessionId = "",
                            SubscriptionId = ""
                        });
